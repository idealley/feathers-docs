...
## Caching
- [feathers-hooks-rediscache](https://github.com/idealley/feathers-hooks-rediscache) - API cache with redis. Cache any route. Routes endpoint for managing the cache. - Initial version
